...
#include "../../qt-04-signals-and-slots/logger.h"
...
QT_MOC_LITERAL(1, 7, 16), // "logAccountChange"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10), // "newBalance"
QT_MOC_LITERAL(4, 36, 15), // "logTotalBalance"
QT_MOC_LITERAL(5, 52, 14) // "newTotalBalace"

    },
    "Logger\0logAccountChange\0\0newBalance\0"
    "logTotalBalance\0newTotalBalace"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logAccountChange((*reinterpret_cast< long(*)>(_a[1]))); break;
        case 1: _t->logTotalBalance((*reinterpret_cast< long(*)>(_a[1]))); break;
        default: ;
        }
    }
}
