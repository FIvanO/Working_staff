...
#include "../../qt-05-gui/bankaccount.h"
...
QT_MOC_LITERAL(4, 39, 15), // "balanceNegative"
QT_MOC_LITERAL(5, 55, 9) // "wrongData"

    },
    "BankAccount\0balanceChanged\0\0newBalance\0"
    "balanceNegative\0wrongData"
};
...
void BankAccount::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BankAccount *_t = static_cast<BankAccount *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->balanceChanged((*reinterpret_cast< long(*)>(_a[1]))); break;
        case 1: _t->balanceNegative(); break;
        case 2: _t->wrongData(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (BankAccount::*_t)(long );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BankAccount::balanceChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (BankAccount::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BankAccount::balanceNegative)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (BankAccount::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BankAccount::wrongData)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject BankAccount::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BankAccount.data,
      qt_meta_data_BankAccount,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void BankAccount::balanceChanged(long _t1)
{
...
// SIGNAL 1
void BankAccount::balanceNegative()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void BankAccount::wrongData()
{
